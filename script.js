...
function displayPlayers(playersData) {
    ...
    playersData.forEach((player) => {
        ...
        playerCard.innerHTML = `
            <img src="./${player.id}.jpg" alt="${player.playerName}"> 
        ...
        playerCard.addEventListener("click", () => {
            // Redirect to the player details page with the player's ID as a query parameter
            window.location.href = `player_details.html?id=${player.id}`;
        });
